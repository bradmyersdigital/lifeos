  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      <textarea placeholder="Start writing…" value={body} onChange={e => setBody(e.target.value)}
        style={{ width: '100%', background: 'transparent', border: 'none', outline: 'none', fontSize: 16, color: 'var(--text-secondary)', fontFamily: "'DM Sans'", resize: 'none', lineHeight: 1.7, padding: 0, minHeight: 220 }} />
